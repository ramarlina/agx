...
export const ActionToolbar = forwardRef<HTMLDivElement, ActionToolbarProps>(
  ({ children, className = '', ...props }, ref) => {
    const baseClasses = "absolute top-4 right-4 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-[var(--app-shell-elevated)] border border-[var(--app-shell-border)] shadow-md rounded-lg p-1 z-10 backdrop-blur-sm";
