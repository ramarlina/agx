...
function isJobOverdue(epochMs: number | null, state: string): boolean {
            ...
            <div className="space-y-0">
              ...
              <div className="border-t border-[var(--card-border)] px-6 py-4">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className={`text-[11px] ${isJobOverdue(job.nextRunAt, job.state) ? "text-amber-400 font-medium" : "text-[var(--muted-foreground)]"}`}>
                    ...
                    <div className="flex items-start gap-4">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-[12px] text-[var(--muted-foreground)]">
                          ...
                          <span className={`flex items-center gap-1 ${isJobOverdue(job.nextRunAt, job.state) ? "text-amber-400 font-medium" : ""}`}>
                            <Clock size={11} />
