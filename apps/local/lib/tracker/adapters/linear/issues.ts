...
import {
  countCachedTrackerItems as countCachedLinearIssues,
  getCachedTrackerItemContexts as getCachedLinearIssueContexts,
  getTrackerItemSyncState as getLinearIssueSyncState,
  listCachedTrackerItems as listCachedLinearIssues,
  replaceCachedTrackerItems as replaceCachedLinearIssues,
  setTrackerItemSyncState as setLinearIssueSyncState,
  type CachedTrackerItemInput as CachedLinearIssueInput,
