...
export function ProjectLayoutClient({ children, slug }: ProjectLayoutClientProps) {
  ...
  const activeProjectView = useMemo<"home" | "objectives" | "teams" | "thread" | "automations" | "linear" | "terminal" | "env-vars" | "folders" | "notifications">(
    () => {
