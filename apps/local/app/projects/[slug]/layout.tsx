...
function ProjectLayoutContent({
  ...
  const activeProjectView = useMemo<"overview" | "objectives" | "teams" | "thread" | "knowledge" | "automations" | "linear" | "terminal" | "settings">(
    () => {
          ...
          <div className="flex items-center gap-1.5 min-w-0 flex-shrink-0">
            ...
            {activeProjectView !== "overview" && (
              <>
                ...
                >
                  {{ objectives: "Objectives", teams: "Teams", linear: "Linear", automations: "Scheduled Tasks", thread: "Chat", knowledge: "Knowledge", terminal: "Terminal", settings: "Settings" }[activeProjectView] ?? activeProjectView}
                </button>
