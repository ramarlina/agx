...
function loadCloudConfig() {
  ...
  if (process.env.AGX_BOARD_URL || process.env.AGX_CLOUD_URL) {
    return {
      apiUrl: process.env.AGX_BOARD_URL || process.env.AGX_CLOUD_URL,
  ...
  // Try config file
  try {
    const configPath = path.join(CONFIG_DIR, 'cloud-config.json');
