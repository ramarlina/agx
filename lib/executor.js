...
const PROJECT_CONTEXT = [
  ...
  'Task state lives in the cloud API (goal, criteria, progress, learnings) along with Temporal workflows; `agx info`/`agx context` expose structured project metadata.',
  ...
  'Task management commands include `agx task ls`, `agx task logs`, `agx task stop`, `agx task rm`, `agx complete`, `agx pull`, and `agx nudge` for guidance.',
