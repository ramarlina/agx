...
const STAGE_CONFIG = {
  ...
  deployment: {
    prompt: 'Deploy to production environment. Verify deployment succeeded.',
    outputs: ['deployment_log.md'],
  },
  smoke_test: {
    prompt: 'Run smoke tests in production. Verify critical paths work.',
    outputs: ['smoke_test_results.md'],
  },
  release: {
    prompt: 'Update docs, changelog, announce release.',
    outputs: ['changelog.md', 'announcement.md'],
  },
  done: {
