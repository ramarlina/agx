...
agx board start         # Start the UI
agx board stop          # Stop the UI
agx board status        # UI status
agx board open          # Open the UI in browser
agx board logs          # UI logs
...
\`\`\`bash
agx chat send "msg"     # Send a message to a thread
# agx chat / start / stop are deprecated wrappers for agx board
\`\`\`
