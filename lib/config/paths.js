...
const AGX_HOME_DIR = process.env.AGX_HOME || path.join(HOME_DIR, '.agx');

// Config paths
const CONFIG_DIR = AGX_HOME_DIR;
const CONFIG_FILE = path.join(CONFIG_DIR, 'config.json');
const CLOUD_CONFIG_FILE = path.join(CONFIG_DIR, 'cloud.json'); // legacy, used for migration only
